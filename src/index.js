...
const catchPoke = require('../commands/catch')
...
bot.on('message', async msg => {
    ...
    if (msg.content.startsWith(PREFIX)){
        ...
        if (CMD_NAME === 'intro'){
            ...
            var pokemon = await generate(msg, channelIDs[1])
            if (pokemon) curr_pokemon = pokemon
            ...
            //     }
            // }
            curr_pokemon = await catchPoke(msg, channelIDs[1], curr_pokemon, args)
            ...
            // }
            claim(msg, channelIDs[1], channelIDs[2])
